...
bool CBUSESP8266::available(void) {
...
CANFrame CBUSESP8266::getNextMessage(void) {
...
bool CBUSESP8266::sendMessage(CANFrame *msg, bool rtr, bool ext, byte priority) {
...
void CBUSESP8266::printStatus(void) {
...
void CBUSESP8266::setPins(byte csPin, byte intPin) {
  _csPin = csPin;
  _intPin = intPin;
}
...
void CBUSESP8266::setNumBuffers(byte num_rx_buffers, byte num_tx_buffers) {
...
void CBUSESP8266::setOscFreq(unsigned long freq) {
  _osc_freq = freq;
}
